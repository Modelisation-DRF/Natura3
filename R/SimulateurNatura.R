...
#'    \item propriétés de sol SIIGSOL dans la profondeurt 0-5 cm: ph, clay (proportion d'argile (%)), sand () proportion de sable (%)), cec (capacité d'échange cationique (méq/100g)), oc (proportion de matière organique (%)). Optionnel: peuvent être récupérés avec le package ExtractMap en utilisant \code{sol=T}
